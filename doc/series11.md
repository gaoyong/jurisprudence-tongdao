...
哈特在本小节接下来的主要任务就是如何利用社会规则（或更加具体的某一类型规则）来说明立法者权威的继承性问题（而不必采纳Austin的法理学解释方式）。
...
原讨论文案中对这块的细节不够清晰，原因是在制作文案时笔者未能充分注意 Hart的理论也有其注重Authority(拉丁文 autortitas)和Power的区分。

具体而言，这里需要更细致强化的一点，Hart这里 尤其强调了是立法权威（legislative authority）而不是某种暴力赤裸的权力的传递性问题。

郭斯维这里的讨论对这里的细致化澄清贡献较大，老郭追问了一点，Hart这里谈的是 认为唯一的某个authority 传递问题，还是有复述意义的authorities，在代际权力传递过程当中 是复数的权威有个消解后又重建的过程（采用这样的视角，就没有SCO模型的那个问题，变成了完全的历史解释问题，沿着历史解释问题，老郭继续补充了在中国历史上统治者做权力交接的安排，一种方式为了确保儿子能够接的过老子的权力，提前做人事安排）。

老郭还有一个补充比较好（拓展了问题意识，虽然跟Hart这里的问题探讨距离较远），authority在代际传递当中的“衰减”问题。
